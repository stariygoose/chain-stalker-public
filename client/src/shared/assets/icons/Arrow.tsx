...
export const Arrow: FC<IconProps> = ({ width = 50, height = 50, color, className }) => {
	return (
		<svg className={className} fill={color} height={`${height}px`}width={`${width}px`} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" 
